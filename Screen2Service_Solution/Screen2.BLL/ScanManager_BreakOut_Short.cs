...
{
    public class ScanManager_BreakOut_Short : BaseStatScan
    {
        #region
        private double Stop_Level = 0.99;
        private string SET_Ref = "Breakout_Short";
        private double ADX_Narrow = 3;
        #endregion

        #region Constructors
        public ScanManager_BreakOut_Short()
        {

        }

        public ScanManager_BreakOut_Short(IUnitWork unit) : base(unit)
        {
        }
        #endregion
